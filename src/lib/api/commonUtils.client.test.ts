import { getToken as originalGetToken } from '@/lib/api/authTokenFetcher.client';
const getToken = originalGetToken as jest.MockedFunction<typeof originalGetToken>;

// test target method
import { request } from '@/lib/api/commonUtils.client';

// Mock fetch and getToken
global.fetch = jest.fn() as jest.MockedFunction<typeof fetch>;
jest.mock('@/lib/api/authTokenFetcher.client');
